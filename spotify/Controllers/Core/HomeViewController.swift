...
enum BrowseSectionType {
    ...
    case featuredPlaylists(viewModels: [FeaturedPlaylistsViewModel])  // 2
...
class HomeViewController: UIViewController {
    ...
    APICaller.shared.getRecommendedGenres{ result in
        ...
        case .success(let result):
            ...
            while seeds.count < 5 {
                if let ele = result.genres.randomElement(){
                    seeds.insert(ele)
                }
            }
        ...
        group.notify(queue: .main){
            ...
            print("Calling configure models")
    ...
    private func configureModels(newAlbums: [Album], playlists: [Playlist], tracks:[AudioTrack]){
        ...
        sections.append(.featuredPlaylists(viewModels: playlists.compactMap({
            return FeaturedPlaylistsViewModel(
                name: $0.name,
                artWorkURL: URL(string:$0.images.first?.url ?? ""),
    ...
    private static func createSectionLayout(index: Int) -> NSCollectionLayoutSection {
        ...
        switch index{
        // Return section for New Releases
        case 0:
            // Item
        ...
        // Return Section For Featured Playlists
        case 1:
            // Item
            ...
            // Return Section for RecommenedPlaylists
        case 2:
            // Item
            let item = NSCollectionLayoutItem(layoutSize: NSCollectionLayoutSize(
...
extension HomeViewController: UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case .newReleases:
            ...
            //  print("tapped on the album: \(album)")
